...
public:
    ...
    /** Removes all multi handles, watches, and timers and suppresses retained request handlers. */
     ...
     * A successful call delivers one later HttpErrorKind::Cancelled completion and repeated cancellation is rejected.
     */
