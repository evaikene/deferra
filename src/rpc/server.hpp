...
public:
    ...
    ///
    /// Framing, device, short-write, output-framing, output-codec, and output-limit failures are terminal. Parse
    /// errors, invalid requests, missing methods, and handler failures are represented on the wire and do not emit this
    /// signal.
    ///
