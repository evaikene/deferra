...
using JsonResult = jb::core::Result<jb::core::JsonValue, jb::core::Error>;
...
static_assert(
    std::is_same_v<decltype(&jb::jobu::queue_selector_from_json),
                   jb::core::Result<jb::jobu::QueueSelector, jb::core::Error> (*)(jb::core::JsonValue const&)>);
static_assert(std::is_same_v<
              decltype(&jb::jobu::create_queue_request_from_json),
              jb::core::Result<jb::jobu::CreateQueueRequest, jb::core::Error> (*)(jb::core::JsonValue const&,
...
static_assert(
    std::is_same_v<decltype(&jb::jobu::job_from_json),
                   jb::core::Result<jb::jobu::JobDefinition, jb::core::Error> (*)(jb::core::JsonValue const&,
                                                                                  jb::jobu::AttributeRegistry const&)>);
...
static_assert(std::is_same_v<
              ...
              jb::core::Result<jb::jobu::UpdateJobRequest, jb::core::Error> (*)(jb::core::JsonValue const&,
                                                                                jb::jobu::AttributeRegistry const&)>);
static_assert(
